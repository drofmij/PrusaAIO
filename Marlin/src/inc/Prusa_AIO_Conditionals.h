...
// Define MOTHERBOARD here so preflight-checks.py works
  ...
  #define NO_MK3_FAN_PINS_WARNING 1
  ...
  #define PRUSA_AIO_TFT_SERIAL_PORT 3                             // AUX-1
  #define PRUSA_AIO_BOARD_NEOPIXEL_PIN PA2
#elif ENABLED(PRUSA_AIO_MOTHERBOARD_EINSY_RAMBO)
  #define MOTHERBOARD BOARD_EINSY_RAMBO
  #define PRUSA_AIO_NO_DRIVER_UART_SPI_JUMPERS 1
  #define PRUSA_AIO_SDCARD_CONNECTION LCD
  #define PRUSA_AIO_USB_SERIAL_PORT 0
  // #define PRUSA_AIO_BOARD_NEOPIXEL_PIN PE6
  #define NO_MK3_FAN_PINS_WARNING 1
#endif
...
//===========================================================================
  ...
  #define PRUSA_AIO_XY_MIN_ENDSTOP_HIT_STATE TERN(SENSORLESS_HOMING, LOW, HIGH)
    ...
    #define PRUSA_AIO_DRIVER_RSENSE 0.22
  #else
    #define PRUSA_AIO_DRIVER_RSENSE 0.11
    #define TMC_USE_SW_SPI
  #endif
#elif ENABLED(PRUSA_AIO_DRIVERS_TMC2240)
  #define PRUSA_AIO_DRIVER_TYPE TMC2240
  #define PRUSA_AIO_XY_MIN_ENDSTOP_HIT_STATE TERN(SENSORLESS_HOMING, HIGH, LOW)
  #define PRUSA_AIO_DRIVER_RSENSE 0.11 // Unused
  #define TMC_USE_SW_SPI
...
// Default Extruder inverting
  ...
  #endif
#elif ANY(PRUSA_AIO_DRIVERS_TMC2209, PRUSA_AIO_DRIVERS_TMC2226_015_RSENSE, PRUSA_AIO_DRIVERS_TMC2226_011_RSENSE, PRUSA_AIO_DRIVERS_TMC2240, PRUSA_AIO_DRIVERS_TMC2130)
  ...
  #define PRUSA_AIO_EXTRUDER_STEPS_PER_UNIT 282.83
...
// User Extruder inverting
  ...
  // StallGuard settings
    ...
    #if ANY(PRUSA_AIO_DRIVERS_TMC5160, PRUSA_AIO_DRIVERS_TMC2240, PRUSA_AIO_DRIVERS_TMC2130)
